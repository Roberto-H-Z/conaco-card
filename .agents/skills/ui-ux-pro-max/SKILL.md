---
name: ui-ux-pro-max
description: "UI/UX design intelligence for web, mobile, and desktop. Use this skill only when the user explicitly requests ui-ux-pro-max or explicitly asks to apply the project's UI/UX skill. Searchable local data: 79 searchable styles (50 active), 192 product palettes and reasoning profiles, 74 font pairings, 119 UX guidelines, 105 icons, 17 GSAP presets, 25 chart types, and 22 stacks."
---
# ui-ux-pro-max
