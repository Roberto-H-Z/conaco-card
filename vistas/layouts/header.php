...
<header class="kt-header fixed top-0 z-10 start-0 end-0 flex items-stretch shrink-0 bg-background" data-kt-sticky="true" data-kt-sticky-class="border-b border-border" data-kt-sticky-name="header" id="header">
 <div class="kt-container-fixed flex justify-between items-stretch lg:gap-4" id="headerContainer">
  ...
  <div class="hidden lg:flex items-center gap-2"><button class="kt-btn kt-btn-icon kt-btn-ghost kt-btn-sm" id="sidebarToggle" type="button" aria-label="Ocultar menú lateral" aria-expanded="true" title="Ocultar menú lateral"><i class="ki-filled ki-menu text-lg" id="sidebarToggleIcon" aria-hidden="true"></i></button><span class="text-sm text-muted-foreground"><?= e($rolUsuarioBarra) ?></span></div>
